...
**YouNow Activity:** Any user generated content is collected by YouNow, such as when you enter  profile data, create broadcasts, chats, posts, moments, when you gift or fan another user or subscribe to a partner’s broadcasts.
Communication from You: When you contact us with questions, concerns or for purposes of customer/technical support, we collect the information contained in your message, which may include your name, contact details and any other personal data you provide.
...
Automated data collection does not lead to profiling that significantly affects YouNow users, but simply gives YouNow a clear picture of its users and influencers. For a complete listing of data fields collected and used by YouNow, you may contact us at privacy@younow.com
...
•	With third parties performing services on our behalf that have agreed to keep such information confidential (for example, secure payment processing).
